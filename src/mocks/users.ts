...
// Utilisateur principal — candidat connecté (pour le tableau de bord).
  ...
  experiences: [
    {
      ...
      endYear: null,
      description:
        'Développement de plateformes web pour des clients du secteur public et privé. Encadrement d’une équipe de 3 développeurs.',
    },
    {
      ...
      endYear: 2022,
      description:
        'Conception et intégration d’applications web responsive pour divers clients.',
    },
  ],
  education: [
...
// Quelques autres profils mockés (pour le côté organisme / candidatures).
