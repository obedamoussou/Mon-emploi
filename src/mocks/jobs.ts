...
const seeds: Seed[] = [

  {
    ...
    city: 'Port-Akwa',
    summary:
      "La Société Béninoise d'Energie Électrique accélère sa transition énergétique et recrute un ingénieur dédié aux projets solaires et hydroélectriques.",
    missions: [
  ...
  {
    ref: 'MSPH-2026-0142',
    title: 'Neurologue — Centre Hospitalier International de Calavi',
    kind: 'emploi',
    contractType: 'CDI',
    workMode: 'Présentiel',
    level: 'Confirmé',
    ...
    city: 'Mballa',
    summary:
      "Le Centre Hospitalier International de Calavi recrute un neurologue pour renforcer les équipes.",
    missions: [
  ...
  {
    ref: 'SEME-2026-0031',
    title: 'Ingénieur Robotique — Sèmè City',
    kind: 'emploi',
    contractType: 'CDI',
    workMode: 'Hybride',
    level: 'Senior',
    institutionId: 'inst-seme-city',
    categoryId: 'cat-tech',
