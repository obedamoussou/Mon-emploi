import type { Job, ContractType, OpportunityKind, WorkMode, ExperienceLevel } from '~/types'
import { slugify } from '~/lib/utils'

// Helper de génération déterministe pour enrichir le jeu de données.
...
const seeds: Seed[] = [
  {
    ...
    city: 'Mballa',
    summary:
      "Le Ministère de la Santé recrute des médecins généralistes pour renforcer les équipes du Centre Hospitalier Régional de Mballa.",
    missions: [
  ...
  },
  {
    ...
    city: 'National',
    summary:
      "Ouverture du concours national pour le recrutement de 1 200 professeurs de l'enseignement secondaire, toutes disciplines confondues.",
    missions: [
  ...
  },
  {
    ...
    city: 'Nseba',
    summary:
      "La Direction Générale des Impôts recrute par voie de concours des inspecteurs pour renforcer le contrôle fiscal et l'assiette.",
    missions: [
  ...
  },
  {
    ...
    city: 'Nseba',
    summary:
      "La Faculté des Sciences de l'Université Nationale de Nseba recrute un maître de conférences en informatique pour ses formations de licence et master.",
    missions: [
  ...
  },
  {
    ...
    city: 'Port-Akwa',
    summary:
      "La Société Nationale d'Électricité accélère sa transition énergétique et recrute un ingénieur dédié aux projets solaires et hydroélectriques.",
    missions: [
  ...
  },
  {
    ...
    city: 'Nseba',
    summary:
      "La Mairie de Nseba recherche un chargé de l'urbanisme pour instruire les demandes de permis de construire et accompagner le développement urbain.",
    missions: [
  ...
  },
  {
    ...
    city: 'Nseba',
    summary:
      "L'Agence Nationale pour l'Emploi des Jeunes offre un stage de 6 mois en communication digitale au sein de sa direction de la communication.",
    missions: [
  ...
  },
  {
    ...
    city: 'Mballa',
    summary:
      "L'Office National de l'Eau recrute des techniciens supérieurs pour l'exploitation et la maintenance des réseaux d'adduction d'eau potable.",
    missions: [
  ...
  },
  {
    ...
    city: 'Garoua-Sud',
    summary:
      "Espoir & Développement lance un appel à candidatures pour coordonner son programme d'éducation des filles en milieu rural dans la région Nord.",
    missions: [
  ...
  },
  {
    ...
    city: 'Port-Akwa',
    summary:
      "L'Agence Nationale de l'Aviation Civile recrute par concours des contrôleurs de la circulation aérienne pour ses centres de contrôle.",
    missions: [
  ...
  },
  {
    ...
    city: 'Nseba',
    summary:
      "Le Ministère de la Fonction Publique recherche un conseiller pour accompagner la modernisation et la simplification des procédures administratives.",
    missions: [
  ...
  },
  {
    ...
    city: 'Ndelé',
    summary:
      "Santé Pour Tous recrute des infirmiers diplômés d'État pour ses cliniques mobiles intervenant dans les zones rurales enclavées de la région Est.",
    missions: [
  ...
  },
  {
    ...
    city: 'Aného-Cité',
    summary:
      "La Société Nationale des Postes recrute des chargés de clientèle pour développer ses services financiers de proximité dans son réseau d'agences.",
    missions: [
  ...
  },
  {
    ...
    city: 'Port-Akwa',
    summary:
      "L'Université Polytechnique de Port-Akwa recrute un ingénieur de laboratoire pour ses plateaux techniques de génie électrique et d'automatique.",
    missions: [
  ...
  },
  {
    ...
    city: 'Nseba',
    summary:
      "Le Ministère de l'Économie Numérique propose un stage de fin d'études pour participer au développement des interfaces des services publics en ligne.",
    missions: [
  ...
  },
  {
    ...
    city: 'Port-Akwa',
    summary:
      "La Mairie de Port-Akwa recrute un agent de développement économique pour soutenir l'entrepreneuriat et l'attractivité du territoire.",
    missions: [
  ...
  },
  {
    ...
    city: 'Bantou',
    summary:
      "Le Ministère de la Santé organise un concours de recrutement de sages-femmes d'État pour les maternités des hôpitaux de district.",
    missions: [
  ...
  },
  {
    ...
    city: 'Nseba',
    summary:
      "L'Institut National de la Statistique recrute un analyste pour la production et l'analyse des données économiques et sociales nationales.",
    missions: [
  ...
  },
  {
    ...
    city: 'Sokodé-Ville',
    summary:
      "Le Ministère de l'Éducation Nationale recherche des inspecteurs pédagogiques pour l'encadrement et l'évaluation des enseignants du primaire.",
    missions: [
  ...
  },
  {
    ...
    city: 'Garoua-Sud',
    summary:
      "Espoir & Développement offre un stage en suivi-évaluation pour appuyer le pilotage de ses programmes de développement communautaire.",
    missions: [
  ...
  },
  {
    ...
    city: 'Port-Akwa',
    summary:
      "La Société Nationale d'Électricité recrute un juriste pour sécuriser ses contrats, marchés publics et partenariats stratégiques.",
    missions: [
  ...
  },
  {
    ...
    city: 'National',
    summary:
      "Ouverture du concours d'entrée à l'École Nationale d'Administration pour former les futurs hauts cadres de l'administration publique.",
    missions: [
...
export const jobs: Job[] = seeds.map((s, idx) => {
  ...
  return {
    ...
    salary:
      s.salaryMin != null && s.salaryMax != null
        ? { min: s.salaryMin, max: s.salaryMax, currency: 'FCFA', period: 'mois' }
        : undefined,
