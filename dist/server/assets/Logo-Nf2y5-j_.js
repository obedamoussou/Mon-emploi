...
function Logo({
  ...
  return /* @__PURE__ */ jsxs(
    Link,
    {
      ...
      "aria-label": "Présidence de la République du Bénin — accueil",
      children: [
        ...
        /* @__PURE__ */ jsxs("span", { className: "flex max-w-[12.5rem] flex-col leading-tight sm:max-w-none", children: [
          /* @__PURE__ */ jsx(
            "span",
            {
              ...
              children: "Présidence de la République du Bénin"
            }
          ),
          /* @__PURE__ */ jsx(
            "span",
            {
              ...
              children: "Plateforme nationale de mobilisation des talents"
            }
          )
        ] })
      ]
