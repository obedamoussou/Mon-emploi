...
import { d as deadlineLabel, t as timeAgo, c as cn, b as formatSalary } from "./Logo-B1bRgxRh.js";
function JobCard({
  job,
  index = 0,
  minimal = false
          ...
          Link,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "mt-3.5 flex flex-wrap items-center gap-x-3 gap-y-2 text-xs text-ink-500 sm:mt-4 sm:gap-x-4", children: [
                !minimal && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center gap-1.5", children: [
              ...
              !minimal && job.salary && /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm font-semibold text-accent-700", children: formatSalary(job.salary.min, job.salary.max, job.salary.currency, job.salary.period) })
            ]
          }
        ),
        /* @__PURE__ */ jsx(
