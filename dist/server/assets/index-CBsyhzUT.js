...
import { o as orgMessages, a as orgCandidates, b as orgOffers, d as applicationsTrend, e as orgStats } from "./dashboard-BcJXNfdw.js";
import { c as cn, i as initials, f as formatNumber } from "./Logo-Nf2y5-j_.js";
import { c as Route } from "./router-BsMxc6_M.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid gap-6 lg:grid-cols-[1.5fr_1fr]", children: [
      /* @__PURE__ */ jsxs("div", { className: "card p-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-6 flex h-52 flex-col", children: [
          /* @__PURE__ */ jsx("div", { className: "flex flex-1 items-end gap-3", children: applicationsTrend.map((d, i) => /* @__PURE__ */ jsx("div", { className: "flex h-full flex-1 items-end", children: /* @__PURE__ */ jsx(motion.div, { initial: {
            height: 0
          }, animate: {
            ...
            delay: i * 0.08,
            duration: 0.5
          }, className: "w-full rounded-t-lg bg-gradient-to-t from-brand-600 to-brand-400", title: `${d.value} candidatures` }) }, d.month)) }),
          /* @__PURE__ */ jsx("div", { className: "mt-2 flex gap-3", children: applicationsTrend.map((d) => /* @__PURE__ */ jsx("span", { className: "flex-1 text-center text-xs text-ink-400", children: d.month }, d.month)) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "card p-6", children: [
