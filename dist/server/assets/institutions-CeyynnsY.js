const institutions = [
  ...
  },
  {
    ...
    presentation: "Le Centre Hospitalier International de Calavi définit et met en œuvre la politique sanitaire nationale. Il supervise les centres hospitaliers universitaires, les districts sanitaires et les programmes de santé publique, et recrute chaque année des milliers de professionnels de santé.",
    regionId: "reg-cap",
    city: "Nseba",
  ...
  },
  {
    ...
    logoColor: "#0d9488",
    logoInitials: "SC",
    description: "Cité internationale de l’innovation et du savoir : recherche, technologies de pointe et entrepreneuriat.",
    presentation: "Sèmè City est la cité de l'innovation et du savoir du Bénin. Elle réunit universités, centres de recherche, startups et industries de pointe autour de la robotique, du numérique, des énergies et de l'agro-technologie, et recrute des talents pour bâtir l'économie de demain.",
  ...
  },
  {
    ...
    presentation: "La Société Béninoise d’Energie Électrique assure la production, le transport et la distribution de l'énergie électrique sur tout le territoire. Engagée dans la transition énergétique, elle recrute ingénieurs, techniciens et gestionnaires pour ses projets d'électrification rurale et solaire.",
    regionId: "reg-littoral",
    city: "Port-Akwa",
