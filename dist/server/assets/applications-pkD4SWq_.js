import { s as slugify } from "./Logo-Nf2y5-j_.js";
...
const seeds = [
  {
    ...
    city: "Port-Akwa",
    summary: "La Société Béninoise d'Energie Électrique accélère sa transition énergétique et recrute un ingénieur dédié aux projets solaires et hydroélectriques.",
    missions: [
  ...
  },
  {
    ...
    regionId: "reg-centre",
    city: "Mballa",
    summary: "Le Centre Hospitalier International de Calavi recrute un neurologue pour renforcer les équipes.",
    missions: [
  ...
  // },
  {
    ...
    city: "Sèmè-Podji",
    summary: "Rejoignez une équipe de passionné pour concevoir, programmer et déployer des systèmes automatisés et des machines intelligentes.",
    missions: [
  ...
  },
  {
    ...
    regionId: "reg-cap",
    city: "Nseba",
    summary: "Le Ministère de l’Économie et des Finances recherche un expert en financement durable.",
    missions: [
